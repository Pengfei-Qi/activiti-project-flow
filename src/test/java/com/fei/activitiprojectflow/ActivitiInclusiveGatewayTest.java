 ...
 * @version: 1.0
 */
public class ActivitiInclusiveGatewayTest extends ActivitiProjectFlowApplicationTests{
    @Autowired
    ...
    final String processDefinitionKey1 =  "myInclusive" ;
    ...
    public void completeTask() {
        ...
        list.forEach((e) -> {
            ...
            BusinessPojo exclusive = (BusinessPojo) taskService.getVariable(e.getId(), "inclusive");
